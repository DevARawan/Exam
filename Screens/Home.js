  ...
  const renderListItem = ({ item }) => (
    <View style={styles.listItem}>
      ...
      <View style={styles.rowItem}>
          ...
          <Text style={styles.itemDetail}>Author: {item.Author}</Text>
        </View>
        <View style={styles.rowItem}>
          <Ionicons name="notes" size={16} color="#3498db" />
          <Text style={styles.itemDetail}>Sub Headings: {item.Sub_Headings}</Text>
        </View>
      ...
      <View style={styles.rowContainer}>
        ...
        <View style={styles.rowItem}>
          ...
          <Text style={styles.itemDetail}>
            On Base Percentage: {item.On_Base_Percentage}
          </Text>
        </View>
      </View>
